...
// Must match what the module's `jar` task actually produces. This pointed at a stale
// `-dev` artifact, so every change to the 1.21 handler was silently left out of the bundle.
