...
/**
 * Cycles through a list of 5 items on a repeating task.
 * You can call [getCurrent] at any time to get whichever item is "active"
 * in the rotation at that moment.
 */
class ItemStackRotator(
    private val materials: List<ItemStack>,
    private val intervalTicks: Long = 25L,
    ...
    private var index = 0
    private var current: ItemStack = materials.first()
    ...
    fun getCurrent(): ItemStack = current
}