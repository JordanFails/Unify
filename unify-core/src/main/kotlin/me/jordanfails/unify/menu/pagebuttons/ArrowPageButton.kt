...
class ArrowPageButton(private val mod: Int, private val menu: PaginatedMenu) : Button() {
    ...
    override fun getMaterial(player: Player): Material {
        if (!hasNext(player)) {
            return XMaterial.BLACK_STAINED_GLASS_PANE.get() ?: Material.BLACK_STAINED_GLASS_PANE
        }
